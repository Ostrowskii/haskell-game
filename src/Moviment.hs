module Moviment (handleInputMoviment, updateWorld) where
    ...
    -- calculateXBlockInFrontOfPlayer :: WorldData  -> Int
    -- calculateXBlockInFrontOfPlayer    world       = 

    --     let playerMoviment = (world playerMoviment)
    --         (x,y)   = playerMoviment + calculateMoviment
